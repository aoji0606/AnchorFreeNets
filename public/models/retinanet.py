...
from public.backbone import ResNetBackbone
from public.neck import RetinaFPN
from public.head import RetinaClsHead, RetinaRegHead
from public.models.anchor import RetinaAnchors
...
model_urls = {
    ...
    'resnet101_retinanet':
    '{}/detection_models/resnet101_retinanet_coco_resize667_mAP0.306.pth'.
    format(pretrained_models_path),
    'resnet152_retinanet':
    'empty',
}
