...
import sys
sys.path.append("/home/jovyan/miniconda3/envs/rk/lib/python3.8/site-packages/torchvision/models/")
...
model_urls = {
    'mobilenet_v2': '{}/mobilenet/mobilenet_v2-b0353104.pth'.format(pretrained_models_path),
}
